...
Move the previously cloned repository or clone it again to the `<GOPATH>/src/github.com/Prakhar-Agarwal-byte/moby` directory.

## 2. Configure IDE

Open the `<GOPATH>/src/github.com/Prakhar-Agarwal-byte/moby` directory in GoLand.
